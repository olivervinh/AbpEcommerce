using AbpEcommerce.Configurations.Inventories;
using AbpEcommerce.Configurations.InventoryTickets;
using AbpEcommerce.Configurations.Manufacturers;
using AbpEcommerce.Configurations.Orders;
using AbpEcommerce.Configurations.ProductAttributes;
...
public class AbpEcommerceDbContext :
    AbpDbContext<AbpEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AbpEcommerceDbContext(DbContextOptions<AbpEcommerceDbContext> options)
        : base(options)
    {
