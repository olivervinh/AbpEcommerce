...
namespace AbpEcommerce.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("AbpEcommerce") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "AbpEcommerce",
                DisplayName = "AbpEcommerce API",
                Resources =
                {
                    "AbpEcommerce"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var adminWebClientRootUrl = configurationSection["AbpEcommerce_Admin:RootUrl"].EnsureEndsWith('/');
        ...
        {
            var webClientRootUrl = configurationSection["AbpEcommerce_Web:RootUrl"].EnsureEndsWith('/');

            /* AbpEcommerce_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["AbpEcommerce_Web:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
